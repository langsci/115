...
\ea%1
    \label{ex:engdahl:1}
    \ili{Swedish} (\citealt{Holmberg2002}: 86)
...
\ea%2
    \label{ex:engdahl:2}
    \ili{Danish} (\citealt{Holmberg2002}: 104)
\ea[]{
...
\ea%3
    \label{ex:engdahl:3}
    \ili{Norwegian} 1 (cf. \citealt{Holmberg2002}: 104)
...
\ili{Norwegian} 2 (cf. \citealt{Holmberg2002}: 104)
\ea
...
\ea%5
\label{ex:engdahl:5}
\ili{Norwegian} 1 (\citealt{Holmberg2002}: 106)
...
\ea%6
    \label{ex:engdahl:6}
    \ili{Swedish} (\citealt{Holmberg2002}: 107)
